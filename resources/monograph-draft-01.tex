...
A painting whose ambiguities admit smooth deformation lies in a connected component of $\pi_0(\mathcal{F}(X))$, but possesses nontrivial $\pi_1$, giving rise to homotopy classes of interpretations.
